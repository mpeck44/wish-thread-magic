  ...
  "inline-flex items-center rounded-full border px-3 py-0.5 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        gold: "border-transparent bg-[hsl(var(--gold))] text-gold-foreground",
        premium: "border-transparent bg-gradient-to-r from-primary to-secondary text-primary-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
