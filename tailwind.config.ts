  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 8px hsl(270 80% 30% / 0.2)" },
          "50%": { boxShadow: "0 0 20px hsl(270 80% 30% / 0.4)" },
        },
        "spin-slow": {
      ...
      animation: {
        ...
        "ring-pulse": "ring-pulse 300ms ease-out",
        "check-pop": "check-pop 180ms ease-out",
        "slide-fade-in": "slide-fade-in 350ms ease-out",
      },
    },
  },
